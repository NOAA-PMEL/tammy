...
map = px.scatter_geo(df, lat='latitude', lon='longitude', color=plot_value,
                     fitbounds='locations', height=750, color_continuous_scale=px.colors.sequential.Inferno,
                      hover_data=['drone', 'latitude', 'longitude', 'time', plot_value])
figure = px.line(df, x='time', y=plot_value, color='drone',  hover_data=['drone', 'latitude', 'longitude', 'time', plot_value])
